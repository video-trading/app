...
class AppStateNotifier extends ChangeNotifier {
  Video2TradeFirebaseUser? initialUser;
  Video2TradeFirebaseUser? user;
  ...
  void update(Video2TradeFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
            ...
            FFRoute(
              ...
              builder: (context, params) => TransactionsPageWidget(
                users: params.getParam(
                    'users', ParamType.DocumentReference, false, 'User'),
              ),
            ),
            FFRoute(
              name: 'UploadPage',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/729-interface-slider-music-flat.png',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
