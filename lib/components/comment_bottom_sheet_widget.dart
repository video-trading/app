          ...
          child: PagedListView<DocumentSnapshot<Object?>?, CommentRecord>(
            pagingController: () {
              final Query<Object?> Function(Query<Object?>) queryBuilder =
                  (commentRecord) =>
                      commentRecord.where('video', isEqualTo: widget.video);
            ...
            builderDelegate: PagedChildBuilderDelegate<CommentRecord>(
              ...
              itemBuilder: (context, _, listViewIndex) {
                ...
                return StreamBuilder<UserRecord>(
                  stream: UserRecord.getDocument(listViewCommentRecord.author!),
                        ...
                        children: [
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              ...
                              final commentCreateData = createCommentRecordData(
